...
In this article I demonstrate how to mutate column in data frame with some NA values so that cases where value is NA are assigned some 'real' values (not NAs)
